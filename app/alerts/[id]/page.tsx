      ...
      <div className="relative z-10 p-6 md:p-8 max-w-4xl mx-auto">
        ...
        <header className="flex items-center justify-between mb-8 animate-fade-in-up">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-display font-semibold text-white">SafeStack</span>
          </div>
        </header>
            ...
            <div className="flex items-start justify-between gap-4 mb-5">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex-shrink-0 p-2.5 text-orange-400 hover:bg-orange-500/20 rounded-lg transition-all"
